...
public:
  ...
  /// Format an uninstantiated symbol name and its parameters. Unlike the overload above, the base
  /// is user-provided and any bytes reserved by the partial-instantiation representation are
  /// escaped before parameters are appended.
