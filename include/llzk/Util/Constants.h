...
/// Name of the attribute on a `@product` func that has been automatically aligned from
/// `@compute` + `@constrain` funcs, or on `@compute` and `@constrain` funcs that have been
/// automatically projected from a `@product` func
