...
MLIR_CAPI_EXPORTED MlirAttribute llzkStruct_StructTypeGetName(MlirType type);

/// Returns the parameter of a llzk::component::StructType as an ArrayAttr.
MLIR_CAPI_EXPORTED MlirAttribute llzkStruct_StructTypeGetParams(MlirType type);
...
llzkStruct_StructDefOpGetMemberDef(MlirOperation op, MlirStringRef name);
...
MLIR_CAPI_EXPORTED MlirOperation llzkStruct_StructDefOpGetComputeFuncOp(MlirOperation op);

/// Returns the FuncDefOp operation that defines the constraints of the struct.
MLIR_CAPI_EXPORTED MlirOperation llzkStruct_StructDefOpGetConstrainFuncOp(MlirOperation op);
...
MLIR_CAPI_EXPORTED MlirAttribute llzkStruct_StructDefOpGetFullyQualifiedName(MlirOperation op);

/// Returns true if the struct is the main entry point of the circuit.
LLZK_DECLARE_OP_PREDICATE(Struct, StructDefOp, IsMainComponent);
...
LLZK_DECLARE_OP_PREDICATE(Struct, MemberDefOp, HasPublicAttr);

/// Sets the public attribute in the given member.
MLIR_CAPI_EXPORTED void llzkStruct_MemberDefOpSetPublicAttr(MlirOperation op, bool value);
